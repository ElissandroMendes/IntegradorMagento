...
public class CatalogInventoryStockItemUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.CatalogInventoryStockItemUpdateEntity data;
    ...
    public CatalogInventoryStockItemUpdateRequestParam(
           ...
           br.com.mind.magento.Client.CatalogInventoryStockItemUpdateEntity data) {
     ...
     * @return data
     */
    public br.com.mind.magento.Client.CatalogInventoryStockItemUpdateEntity getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(br.com.mind.magento.Client.CatalogInventoryStockItemUpdateEntity data) {
        this.data = data;
    }
