...
public class SalesOrderInvoiceCreateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.OrderItemIdQty[] itemsQty;
    ...
    public SalesOrderInvoiceCreateRequestParam(
           ...
           br.com.mind.magento.Client.OrderItemIdQty[] itemsQty,
     ...
     * @return itemsQty
     */
    public br.com.mind.magento.Client.OrderItemIdQty[] getItemsQty() {
        return itemsQty;
    }
     ...
     * @param itemsQty
     */
    public void setItemsQty(br.com.mind.magento.Client.OrderItemIdQty[] itemsQty) {
        this.itemsQty = itemsQty;
    }
