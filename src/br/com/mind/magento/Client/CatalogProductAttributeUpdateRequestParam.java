...
public class CatalogProductAttributeUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.CatalogProductAttributeEntityToUpdate data;
    ...
    public CatalogProductAttributeUpdateRequestParam(
           ...
           br.com.mind.magento.Client.CatalogProductAttributeEntityToUpdate data) {
     ...
     * @return data
     */
    public br.com.mind.magento.Client.CatalogProductAttributeEntityToUpdate getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(br.com.mind.magento.Client.CatalogProductAttributeEntityToUpdate data) {
        this.data = data;
    }
