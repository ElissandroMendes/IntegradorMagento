...
public class CustomerCustomerUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.CustomerCustomerEntityToCreate customerData;
    ...
    public CustomerCustomerUpdateRequestParam(
           ...
           int customerId,
           br.com.mind.magento.Client.CustomerCustomerEntityToCreate customerData) {
     ...
     * @return customerData
     */
    public br.com.mind.magento.Client.CustomerCustomerEntityToCreate getCustomerData() {
        return customerData;
    }
     ...
     * @param customerData
     */
    public void setCustomerData(br.com.mind.magento.Client.CustomerCustomerEntityToCreate customerData) {
        this.customerData = customerData;
    }
