...
public class ShoppingCartPaymentMethodRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.ShoppingCartPaymentMethodEntity paymentData;
    ...
    public ShoppingCartPaymentMethodRequestParam(
           ...
           int quoteId,
           br.com.mind.magento.Client.ShoppingCartPaymentMethodEntity paymentData,
     ...
     * @return paymentData
     */
    public br.com.mind.magento.Client.ShoppingCartPaymentMethodEntity getPaymentData() {
        return paymentData;
    }
     ...
     * @param paymentData
     */
    public void setPaymentData(br.com.mind.magento.Client.ShoppingCartPaymentMethodEntity paymentData) {
        this.paymentData = paymentData;
    }
