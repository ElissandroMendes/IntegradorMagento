...
public class CustomerAddressUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.CustomerAddressEntityCreate addressData;
    ...
    public CustomerAddressUpdateRequestParam(
           ...
           int addressId,
           br.com.mind.magento.Client.CustomerAddressEntityCreate addressData) {
     ...
     * @return addressData
     */
    public br.com.mind.magento.Client.CustomerAddressEntityCreate getAddressData() {
        return addressData;
    }
     ...
     * @param addressData
     */
    public void setAddressData(br.com.mind.magento.Client.CustomerAddressEntityCreate addressData) {
        this.addressData = addressData;
    }
