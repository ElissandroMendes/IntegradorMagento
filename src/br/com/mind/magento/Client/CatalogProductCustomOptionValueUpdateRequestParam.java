...
public class CatalogProductCustomOptionValueUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.Client.CatalogProductCustomOptionValueUpdateEntity data;
    ...
    public CatalogProductCustomOptionValueUpdateRequestParam(
           ...
           br.com.mind.magento.Client.CatalogProductCustomOptionValueUpdateEntity data,
     ...
     * @return data
     */
    public br.com.mind.magento.Client.CatalogProductCustomOptionValueUpdateEntity getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(br.com.mind.magento.Client.CatalogProductCustomOptionValueUpdateEntity data) {
        this.data = data;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Magento", ">catalogProductCustomOptionValueUpdateRequestParam"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:Magento", "catalogProductCustomOptionValueUpdateEntity"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
