...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private br.com.mind.magento.client.AssociativeMultiEntity[] multi_data;

    private br.com.mind.magento.client.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           br.com.mind.magento.client.AssociativeMultiEntity[] multi_data,
           br.com.mind.magento.client.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public br.com.mind.magento.client.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(br.com.mind.magento.client.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public br.com.mind.magento.client.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(br.com.mind.magento.client.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
