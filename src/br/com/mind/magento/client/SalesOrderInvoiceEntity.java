...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.client.SalesOrderInvoiceItemEntity[] items;

    private br.com.mind.magento.client.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           br.com.mind.magento.client.SalesOrderInvoiceItemEntity[] items,
           br.com.mind.magento.client.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public br.com.mind.magento.client.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(br.com.mind.magento.client.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public br.com.mind.magento.client.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(br.com.mind.magento.client.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
