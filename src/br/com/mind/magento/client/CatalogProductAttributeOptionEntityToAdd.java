...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private br.com.mind.magento.client.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           br.com.mind.magento.client.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public br.com.mind.magento.client.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(br.com.mind.magento.client.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
