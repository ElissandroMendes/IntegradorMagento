...
public class SalesOrderCreditmemoData  implements java.io.Serializable {
    private br.com.mind.magento.client.OrderItemIdQty[] qtys;
    ...
    public SalesOrderCreditmemoData(
           br.com.mind.magento.client.OrderItemIdQty[] qtys,
     ...
     * @return qtys
     */
    public br.com.mind.magento.client.OrderItemIdQty[] getQtys() {
        return qtys;
    }
     ...
     * @param qtys
     */
    public void setQtys(br.com.mind.magento.client.OrderItemIdQty[] qtys) {
        this.qtys = qtys;
    }
