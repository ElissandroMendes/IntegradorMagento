...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.client.old.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           br.com.mind.magento.client.old.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public br.com.mind.magento.client.old.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(br.com.mind.magento.client.old.AssociativeEntity[] products) {
        this.products = products;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductTagInfoEntity"));
