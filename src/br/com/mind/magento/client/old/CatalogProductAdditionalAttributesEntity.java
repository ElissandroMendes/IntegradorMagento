...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private br.com.mind.magento.client.old.AssociativeMultiEntity[] multi_data;

    private br.com.mind.magento.client.old.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           br.com.mind.magento.client.old.AssociativeMultiEntity[] multi_data,
           br.com.mind.magento.client.old.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public br.com.mind.magento.client.old.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(br.com.mind.magento.client.old.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public br.com.mind.magento.client.old.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(br.com.mind.magento.client.old.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductAdditionalAttributesEntity"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("multi_data");
        elemField.setXmlName(new javax.xml.namespace.QName("", "multi_data"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "associativeMultiEntity"));
