...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private br.com.mind.magento.client.old.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           br.com.mind.magento.client.old.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public br.com.mind.magento.client.old.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(br.com.mind.magento.client.old.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductAttributeOptionEntityToAdd"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("label");
        elemField.setXmlName(new javax.xml.namespace.QName("", "label"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductAttributeOptionLabelEntity"));
