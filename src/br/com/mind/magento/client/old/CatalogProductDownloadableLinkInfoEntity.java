...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private br.com.mind.magento.client.old.CatalogProductDownloadableLinkEntity[] links;

    private br.com.mind.magento.client.old.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           br.com.mind.magento.client.old.CatalogProductDownloadableLinkEntity[] links,
           br.com.mind.magento.client.old.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public br.com.mind.magento.client.old.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(br.com.mind.magento.client.old.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public br.com.mind.magento.client.old.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(br.com.mind.magento.client.old.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductDownloadableLinkInfoEntity"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("links");
        elemField.setXmlName(new javax.xml.namespace.QName("", "links"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductDownloadableLinkEntity"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("samples");
        elemField.setXmlName(new javax.xml.namespace.QName("", "samples"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "catalogProductDownloadableLinkSampleEntity"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
