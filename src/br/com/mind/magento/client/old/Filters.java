...
public class Filters  implements java.io.Serializable {
    private br.com.mind.magento.client.old.AssociativeEntity[] filter;

    private br.com.mind.magento.client.old.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           br.com.mind.magento.client.old.AssociativeEntity[] filter,
           br.com.mind.magento.client.old.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public br.com.mind.magento.client.old.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(br.com.mind.magento.client.old.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public br.com.mind.magento.client.old.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(br.com.mind.magento.client.old.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "filters"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "complexFilter"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
