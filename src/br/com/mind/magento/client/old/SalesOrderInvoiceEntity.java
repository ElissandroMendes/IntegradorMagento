...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.client.old.SalesOrderInvoiceItemEntity[] items;

    private br.com.mind.magento.client.old.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           br.com.mind.magento.client.old.SalesOrderInvoiceItemEntity[] items,
           br.com.mind.magento.client.old.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public br.com.mind.magento.client.old.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(br.com.mind.magento.client.old.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public br.com.mind.magento.client.old.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(br.com.mind.magento.client.old.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "salesOrderInvoiceEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "salesOrderInvoiceItemEntity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "salesOrderInvoiceCommentEntity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
