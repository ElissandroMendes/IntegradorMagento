...
public class ApiEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.client.old.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           br.com.mind.magento.client.old.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public br.com.mind.magento.client.old.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(br.com.mind.magento.client.old.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "apiEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.client", "apiMethodEntity"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
