...
public class IntegratorCreateOrderEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.client.IntegratorCreateOrderItemEntity[] items;
    ...
    public IntegratorCreateOrderEntity(
           ...
           br.com.mind.magento.client.IntegratorCreateOrderItemEntity[] items,
     ...
     * @return items
     */
    public br.com.mind.magento.client.IntegratorCreateOrderItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(br.com.mind.magento.client.IntegratorCreateOrderItemEntity[] items) {
        this.items = items;
    }
