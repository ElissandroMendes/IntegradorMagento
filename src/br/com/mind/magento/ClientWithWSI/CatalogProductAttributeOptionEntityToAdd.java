...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
