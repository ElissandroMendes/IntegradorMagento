...
public class SalesOrderCreditmemoData  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithWSI.OrderItemIdQty[] qtys;
    ...
    public SalesOrderCreditmemoData(
           br.com.mind.magento.ClientWithWSI.OrderItemIdQty[] qtys,
     ...
     * @return qtys
     */
    public br.com.mind.magento.ClientWithWSI.OrderItemIdQty[] getQtys() {
        return qtys;
    }
     ...
     * @param qtys
     */
    public void setQtys(br.com.mind.magento.ClientWithWSI.OrderItemIdQty[] qtys) {
        this.qtys = qtys;
    }
