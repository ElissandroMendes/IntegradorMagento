...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithWSI.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           br.com.mind.magento.ClientWithWSI.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public br.com.mind.magento.ClientWithWSI.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(br.com.mind.magento.ClientWithWSI.CatalogProductImageFileEntity file) {
        this.file = file;
    }
