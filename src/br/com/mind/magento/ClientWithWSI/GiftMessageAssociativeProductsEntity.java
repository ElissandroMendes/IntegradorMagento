...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithWSI.ShoppingCartProductEntity product;

    private br.com.mind.magento.ClientWithWSI.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           br.com.mind.magento.ClientWithWSI.ShoppingCartProductEntity product,
           br.com.mind.magento.ClientWithWSI.GiftMessageEntity message) {
     ...
     * @return product
     */
    public br.com.mind.magento.ClientWithWSI.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(br.com.mind.magento.ClientWithWSI.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public br.com.mind.magento.ClientWithWSI.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(br.com.mind.magento.ClientWithWSI.GiftMessageEntity message) {
        this.message = message;
    }
