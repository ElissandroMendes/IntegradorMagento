...
public class CatalogInventoryStockItemMultiUpdateRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.ClientWithWSI.CatalogInventoryStockItemUpdateEntity[] productData;
    ...
    public CatalogInventoryStockItemMultiUpdateRequestParam(
           ...
           br.com.mind.magento.ClientWithWSI.CatalogInventoryStockItemUpdateEntity[] productData) {
     ...
     * @return productData
     */
    public br.com.mind.magento.ClientWithWSI.CatalogInventoryStockItemUpdateEntity[] getProductData() {
        return productData;
    }
     ...
     * @param productData
     */
    public void setProductData(br.com.mind.magento.ClientWithWSI.CatalogInventoryStockItemUpdateEntity[] productData) {
        this.productData = productData;
    }
