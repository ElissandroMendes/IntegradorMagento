...
public class RewardpointsTransferAddRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.ClientWithWSI.RewardpointsTransferAdd transferData;
    ...
    public RewardpointsTransferAddRequestParam(
           ...
           br.com.mind.magento.ClientWithWSI.RewardpointsTransferAdd transferData) {
     ...
     * @return transferData
     */
    public br.com.mind.magento.ClientWithWSI.RewardpointsTransferAdd getTransferData() {
        return transferData;
    }
     ...
     * @param transferData
     */
    public void setTransferData(br.com.mind.magento.ClientWithWSI.RewardpointsTransferAdd transferData) {
        this.transferData = transferData;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", ">rewardpointsTransferAddRequestParam"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "rewardpointsTransferAdd"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
