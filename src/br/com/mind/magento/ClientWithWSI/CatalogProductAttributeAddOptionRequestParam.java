...
public class CatalogProductAttributeAddOptionRequestParam  implements java.io.Serializable {
    ...
    private br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionEntityToAdd data;
    ...
    public CatalogProductAttributeAddOptionRequestParam(
           ...
           br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionEntityToAdd data) {
     ...
     * @return data
     */
    public br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionEntityToAdd getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(br.com.mind.magento.ClientWithWSI.CatalogProductAttributeOptionEntityToAdd data) {
        this.data = data;
    }
