...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkEntity[] links;

    private br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkEntity[] links,
           br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(br.com.mind.magento.ClientWithoutWSI.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "catalogProductDownloadableLinkInfoEntity"));
