...
public class IntegratorOrderEntity  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Magento", "integratorOrderEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:Magento", "integratorOrderAddressEntity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
