...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithoutWSI.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           br.com.mind.magento.ClientWithoutWSI.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public br.com.mind.magento.ClientWithoutWSI.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(br.com.mind.magento.ClientWithoutWSI.CatalogProductImageFileEntity file) {
        this.file = file;
    }
