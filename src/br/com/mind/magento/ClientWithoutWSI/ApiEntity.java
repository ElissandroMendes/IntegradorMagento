...
public class ApiEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.ClientWithoutWSI.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           br.com.mind.magento.ClientWithoutWSI.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public br.com.mind.magento.ClientWithoutWSI.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(br.com.mind.magento.ClientWithoutWSI.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
