...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements br.com.mind.magento.ClientWithoutWSI.MagentoService {
    ...
    public br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new br.com.mind.magento.ClientWithoutWSI.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
