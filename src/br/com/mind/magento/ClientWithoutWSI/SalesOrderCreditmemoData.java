...
public class SalesOrderCreditmemoData  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithoutWSI.OrderItemIdQty[] qtys;
    ...
    public SalesOrderCreditmemoData(
           br.com.mind.magento.ClientWithoutWSI.OrderItemIdQty[] qtys,
     ...
     * @return qtys
     */
    public br.com.mind.magento.ClientWithoutWSI.OrderItemIdQty[] getQtys() {
        return qtys;
    }
     ...
     * @param qtys
     */
    public void setQtys(br.com.mind.magento.ClientWithoutWSI.OrderItemIdQty[] qtys) {
        this.qtys = qtys;
    }
