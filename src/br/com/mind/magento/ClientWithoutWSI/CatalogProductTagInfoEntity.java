...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] products) {
        this.products = products;
    }
