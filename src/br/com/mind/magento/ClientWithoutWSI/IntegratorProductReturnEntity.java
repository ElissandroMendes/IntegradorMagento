...
public class IntegratorProductReturnEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] attributes;

    private br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] multiselect_attributes;

    private br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableAttribute[] configurable_attributes;

    private br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableProductVariation[] variations;

    private br.com.mind.magento.ClientWithoutWSI.IntegratorBundleProductComponent[] bundle_components;
    ...
    public IntegratorProductReturnEntity(
           br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] attributes,
           br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] multiselect_attributes,
           br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableAttribute[] configurable_attributes,
           br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableProductVariation[] variations,
           br.com.mind.magento.ClientWithoutWSI.IntegratorBundleProductComponent[] bundle_components,
     ...
     * @return attributes
     */
    public br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] getMultiselect_attributes() {
        return multiselect_attributes;
    }
     ...
     */
    public void setMultiselect_attributes(br.com.mind.magento.ClientWithoutWSI.AssociativeEntity[] multiselect_attributes) {
        this.multiselect_attributes = multiselect_attributes;
    }
     ...
     */
    public br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableAttribute[] getConfigurable_attributes() {
        return configurable_attributes;
    }
     ...
     */
    public void setConfigurable_attributes(br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableAttribute[] configurable_attributes) {
        this.configurable_attributes = configurable_attributes;
    }
     ...
     * @return variations
     */
    public br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableProductVariation[] getVariations() {
        return variations;
    }
     ...
     * @param variations
     */
    public void setVariations(br.com.mind.magento.ClientWithoutWSI.IntegratorConfigurableProductVariation[] variations) {
        this.variations = variations;
    }
     ...
     */
    public br.com.mind.magento.ClientWithoutWSI.IntegratorBundleProductComponent[] getBundle_components() {
        return bundle_components;
    }
     ...
     */
    public void setBundle_components(br.com.mind.magento.ClientWithoutWSI.IntegratorBundleProductComponent[] bundle_components) {
        this.bundle_components = bundle_components;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "integratorProductReturnEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "integratorConfigurableAttribute"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "integratorConfigurableProductVariation"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:br.com.mind.magento.ClientWithoutWSI", "integratorBundleProductComponent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
