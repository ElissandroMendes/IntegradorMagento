...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private br.com.mind.magento.ClientWithoutWSI.ShoppingCartProductEntity product;

    private br.com.mind.magento.ClientWithoutWSI.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           br.com.mind.magento.ClientWithoutWSI.ShoppingCartProductEntity product,
           br.com.mind.magento.ClientWithoutWSI.GiftMessageEntity message) {
     ...
     * @return product
     */
    public br.com.mind.magento.ClientWithoutWSI.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(br.com.mind.magento.ClientWithoutWSI.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public br.com.mind.magento.ClientWithoutWSI.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(br.com.mind.magento.ClientWithoutWSI.GiftMessageEntity message) {
        this.message = message;
    }
